...
while(FINISHED == False and super_counter < 3):
    ...
    #subprocess.run("cp "+str(starter_csv)+" /pscratch/sd/s/sdough/NEW_DATA_OCT_25_2023/DL4neurons2/unit_params.csv", shell=True)
    subprocess.run("cp "+str(ender_csv)+" /pscratch/sd/s/sdough/NEW_DATA_OCT_25_2023/DL4neurons2/"+str(ender_csv), shell=True)
